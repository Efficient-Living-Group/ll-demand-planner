...
const TRACKING_SCHEMA_VERSION = '2026-08-03-regional-3pl-v4';
...
const CK_DEFS = {
  ...
  'case-goods': { name:'Case Goods', prefix:'MULTI', option1:'Case goods - Active', productStatus:'Public', filter:isCaseGoodsSku }
};
