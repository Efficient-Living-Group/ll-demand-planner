...
// ===== CK DEFINITIONS =====
const CK_DEFS = {
  'llau':      { name: 'Little Lifely AU',              prefix: 'LLAU-CB-', logo: 'little-lifely.png', store: 'lifely', excludeCV: false, poDestination: 'Australia', salesCountry: 'AU', stockBranches: LL_AU_BRANCH_IDS, filter: sku => !sku.includes('CBCF'), sizes: {'PACK':'Swatch Packs','-S-':'Single','-KS-':'King Single','-D-':'Double'} },
  'llnz':      { name: 'Little Lifely NZ',              prefix: 'LLAU-CB-', logo: 'little-lifely.png', store: 'lifely', excludeCV: false, poDestination: 'New Zealand', salesCountry: 'NZ', stockBranches: LL_NZ_BRANCH_IDS, strictStockBranches: true, filter: sku => !sku.includes('CBCF'), sizes: {'PACK':'Swatch Packs','-S-':'Single','-KS-':'King Single','-D-':'Double'} },
  ...
  'llna':     { name: 'Little Lifely NA',       prefix: 'LLNA',   logo: 'little-lifely.png', store: 'lifely', excludeCV: false, poDestination: 'United States', salesCountry: 'US', stockBranches: [60701], sizes: {'-TWX-':'Twin XL','-TW-':'Twin','-F-':'Full'} },
  'llca':     { name: 'Little Lifely CA',       prefix: 'LLNA',   logo: 'little-lifely.png', store: 'lifely', excludeCV: false, poDestination: 'Canada', salesCountry: 'CA', stockBranches: [61831], sizes: {'-TWX-':'Twin XL','-TW-':'Twin','-F-':'Full'} },
  ...
  'cusb-au-snuggle': { name: 'Cushie Snuggle Bed',    prefix: 'MULTI',  logo: 'cushie.png',        store: 'lifely', poDestination: 'Australia', salesCountry: 'AU', stockBranches: LL_AU_BRANCH_IDS, filter: sku => sku.startsWith('CUSB') && !sku.includes('-UK') && !sku.includes('SGE'), excludeCV: true, sizes: {'ARST':'Armrest','-TW-':'Twin','-D-':'Double','-Q-':'Queen','-K-':'King'} },
  'cusb-au-lifely':  { name: 'Lifely Sofabed',         prefix: 'MULTI',  logo: 'cushie.png',        store: 'lifely', poDestination: 'Australia', salesCountry: 'AU', stockBranches: LL_AU_BRANCH_IDS, filter: sku => sku.startsWith('LFSB') && !sku.includes('-UK'), excludeCV: true, sizes: {'-TW-':'Twin','-S-':'Single','-D-':'Double','-Q-':'Queen','-CHS-':'Chaise','-SOTM-':'Ottoman','-AMST-':'Armrest'} },
